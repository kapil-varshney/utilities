...
from trainingplot_multimetric import TrainingPlot_Multimetric

# Provide the output path and name for the plot
filename = 'output2/training_plot.jpg'

# Create an instance of the TrainingPlot_Multimetric class with the filename.
plot_losses = TrainingPlot_Multimetric(metrics=['accuracy', 'precision', 'recall'])
